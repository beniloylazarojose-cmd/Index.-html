...
<head>
  ...
  <style>
    ...
    .card { background: white; padding: 15px; margin-bottom: 15px; border-radius: 5px; box-shadow: 0 0 5px #ccc; }
    .btn { background: red; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; }
  </style>
</head>
<body>

<header>
  <h1>🤑 Palpites de LT</h1>
  <p>O teu guia para ganhar na Lotaria Nacional!</p>
</header>

<nav>
  <a href="#gratis">Palpites Grátis</a>
